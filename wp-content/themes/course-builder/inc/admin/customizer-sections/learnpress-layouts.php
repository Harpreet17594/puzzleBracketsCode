...
thim_customizer()->add_field(
	array(
		...
		'type'     => 'radio-image',
		'label'    => esc_html__( 'Courses Single Layouts', 'course-builder' ),
...
thim_customizer()->add_field(
	array(
		'id'              => 'learnpress_single_layout_sidebar_left',
		'type'            => 'select',
		...
		'active_callback' => array(
			array(
				'setting'  => 'learnpress_single_layout',
				'operator' => '===',
				'value'    => 'full-sidebar',
			),
		),
...
thim_customizer()->add_field(
	array(
		'id'              => 'learnpress_single_layout_sidebar_right',
		'type'            => 'select',
