...
thim_customizer()->add_field(
	array(
		...
		'section'   => 'page_title_styling',
		'default'   => '<strong class="br">The best demo education </strong> It is a long established fact that a reade.',
		'priority'  => 6,
		'transport' => 'postMessage',
		'js_vars'   => array(
			array(
...
thim_customizer()->add_field(
	array(
		...
		'type'      => 'color',
		'label'     => esc_html__( "Description <strong> tag Text Color", 'course-builder' ),
