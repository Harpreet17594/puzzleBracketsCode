	...
	'groups'   => array(
		array(
			...
			'fields' => array(
				...
				array(
					'type'     => 'switch',
					'id'       => 'blog_archive_pagetitle',
					'label'    => esc_html__( 'Page Title', 'course-builder' ),
					'tooltip'  => esc_html__( 'Turn on to display blog archive page title.', 'course-builder' ),
					'default'  => true,
					'priority' => 25,
					'choices'  => array(
						true  => esc_html__( 'On', 'course-builder' ),
		...
		array(
			...
			'fields' => array(
				...
				array(
					...
					'label'    => esc_html__( 'Page Title', 'course-builder' ),
					'tooltip'  => esc_html__( 'Turn on to display single blog post title.', 'course-builder' ),
					'default'  => false,
					'priority' => 25,
					'choices'  => array(
						true  => esc_html__( 'On', 'course-builder' ),
