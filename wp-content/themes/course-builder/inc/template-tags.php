...
function thim_render_social_share_link( $social_name ) {
	switch ( $social_name ) {
		case 'facebook':
			return '<li><a class="link facebook" title="' . esc_html__( 'Facebook', 'course-builder' ) . '" href="http://www.facebook.com/sharer/sharer.php?u=' . urlencode( get_permalink() ) . '" rel="nofollow"><i class="fa fa-facebook" aria-hidden="true"></i></a></li>';
			break;

		case 'twitter':
			return '<li><a class="link twitter" title="' . esc_html__( 'Twitter', 'course-builder' ) . '" href="https://twitter.com/intent/tweet?url=' . urlencode( get_permalink() ) . '&amp;text=' . esc_attr( urlencode( get_the_title() ) ) . '" rel="nofollow"><i class="fa fa-twitter" aria-hidden="true"></i></a></li>';
			break;
		...
		case 'linkedin':
			return '<li><a class="link linkedin" target="_blank" title="' . esc_html__( 'LinkedIn', 'course-builder' ) . '" href="http://www.linkedin.com/shareArticle?title=' . esc_attr( urlencode( get_the_title() ) ) . '&amp;url=' . esc_url( urlencode( get_permalink() ) ) . '" rel="nofollow"><i class="fa fa-linkedin" aria-hidden="true"></i></a></li>';
			break;


		case 'google':
			return '<li><a class="link google" title="' . esc_html__( 'Google', 'course-builder' ) . '" href="https://plus.google.com/share?url=' . esc_url( urlencode( get_permalink() ) ) . '" rel="nofollow"><i class="fa fa-google-plus" aria-hidden="true"></i></a>';
			break;
