...
if ( ! function_exists( 'thim_woocommerce_product_filter' ) ) {
	function thim_woocommerce_product_filter() {
		echo '<div class="display grid-list-switch" data-cookie="product-switch">
...
if ( ! function_exists( 'thim_woocommerce_catalog_ordering' ) ) {
	function thim_woocommerce_catalog_ordering() {
		...
		$catalog_orderby_options = apply_filters( 'woocommerce_catalog_orderby', array(
			'menu_order' => esc_html__( 'Default', 'course-builder' ),
			'popularity' => esc_html__( 'Popularity', 'course-builder' ),
			'rating'     => esc_html__( 'Rating', 'course-builder' ),
			'date'       => esc_html__( 'Newness', 'course-builder' ),
			'price'      => esc_html__( 'Price', 'course-builder' ),
		) );
