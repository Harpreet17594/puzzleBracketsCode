...
add_action( 'thim_learning_end_tab_overview', 'learn_press_course_buttons', 61 );
...
//Courses Review
if ( thim_plugin_active( 'learnpres-course-review/learnpres-course-review.php' ) || class_exists( 'LP_Addon_Course_Review' ) ) {
