...
<ul class="lp-form-field-wrap">
	...
	<li class="lp-form-field">
		...
		<div class="lp-form-field-input">
			<input type="text" name="lp_info_major" id="lp_info_major" value="<?php echo esc_attr( $user_meta['lp_info_major'] ) ?>" class="regular-text" />
		</div>
	</li>
	...
	<li class="lp-form-field">
		...
		<div class="lp-form-field-input">
			<textarea name="lp_info_status" id="lp_info_status" rows="3" cols="30"><?php echo esc_html( $user_meta['lp_info_status'] ); ?></textarea>
		</div>
	</li>
