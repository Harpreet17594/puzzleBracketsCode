	...
	<div class="lp-progress">
		<div class="lp-course-status">
			<?php if ( $grade = $user->get_course_grade( $course->id ) ) : ?>
				<span class="lp-grade <?php echo esc_attr( $grade ); ?>">
						<?php learn_press_course_grade_html( $grade ); ?>
						</span>
			<?php endif; ?>
			<span class="text-number"><?php printf( __( '(<b>%d</b> of <b>%d</b> items complete)', 'course-builder' ), $completed_items, $course_items ); ?></span>
		</div>
