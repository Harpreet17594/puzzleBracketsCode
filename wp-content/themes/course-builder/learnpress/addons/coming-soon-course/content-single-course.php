...
$course_title   = get_the_title( get_post_thumbnail_id() ) ? esc_attr( get_the_title( get_post_thumbnail_id() ) ) : '';
...
$image_html     = '<img src="' . esc_url( $image_crop ) . '" alt="' . esc_attr( $course_title ) . '" title="' . esc_attr( $course_title ) . '" />';
